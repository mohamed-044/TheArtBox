...
$oeuvres = [
    [
        ...
        'image' => 'http://localhost/TheArtBox/img/clark-van-der-beken.png'
    ],
        [
        'id' => 2,
        ...
        'image' => 'http://localhost/TheArtBox/img/pawel-czerwinski-3.png'
    ],
        [
        'id' => 3,
        ...
        'image' => 'http://localhost/TheArtBox/img/dan-cristian-padure.png'
    ],
        [
        'id' => 4,
        ...
        'image' => 'http://localhost/TheArtBox/img/steve-johnson-5.png'
    ],
        [
        'id' => 5,
        'titre' => 'Red Washover',
        ...
        'image' => 'http://localhost/TheArtBox/img/steve-johnson.png'
    ],
        [
        'id' => 6,
        'titre' => 'Chromatics',
        ...
        'image' => 'http://localhost/TheArtBox/img/pawel-czerwinski.png'
    ],
        [
        'id' => 7,
        ...
        'image' => 'http://localhost/TheArtBox/img/jazmin-quaynor.png'
    ],
        [
        'id' => 8,
        ...
        'image' => 'http://localhost/TheArtBox/img/steve-johnson-6.png'
    ],
        [
        'id' => 9,
        'titre' => 'Hurricane',
        ...
        'image' => 'http://localhost/TheArtBox/img/victor-grabarczyk.png'
    ],
        [
        'id' => 10,
        ...
        'image' => 'http://localhost/TheArtBox/img/pawel-czerwinski-2.png'
    ],
        [
        'id' => 11,
        'titre' => 'Asimilacion',
        ...
        'image' => 'http://localhost/TheArtBox/img/steve-johnson-2.png'
    ],
        [
        'id' => 12,
        ...
        'image' => 'http://localhost/TheArtBox/img/fly-d.png'
    ],
        [
        'id' => 13,
        ...
        'image' => 'http://localhost/TheArtBox/img/orfeas-green.png'
    ],
        [
        'id' => 14,
        'titre' => 'Mirage',
        ...
        'image' => 'http://localhost/TheArtBox/img/steve-johnson-4.png'
    ],
        [
        'id' => 15,
        ...
        'image' => 'http://localhost/TheArtBox/img/steve-johnson-3.png'
    ],
];
